    ...
    <section id="hero" ref={sectionRef} className="scroll-animation relative">
      ...
      >
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(120% 80% at 50% 10%, transparent 30%, rgba(153, 27, 27, 0.45) 70%, rgba(8, 9, 10, 0.95) 100%)",
          }}
        />
        ...
        >
          <EyebrowBadge className="border-iron-red/30 text-iron-red bg-iron-red/5">AVENGERS INITIATIVE // IRON MAN // EARTH-616 // ONLINE</EyebrowBadge>
          <h1 className="max-w-[14ch] font-heading text-6xl leading-[0.9] tracking-tighter text-foreground md:text-8xl lg:text-9xl">
            <span className="glitch-text" data-text="The Genius.">The Genius.</span>
            <br />
            <span className="glitch-text text-iron-red shimmer-iron" data-text="The Legend.">The Legend.</span>
          </h1>
          <div className="flex flex-col gap-6">
            <p className="max-w-[42ch] font-sans text-sm leading-relaxed text-zinc-400 md:text-base">
              Tony Stark's legacy defined the MCU. Witness the armor that started it all
              and the hero who sacrificed everything for the multiverse.
            </p>
          </div>
        </div>
        ...
        >
          <span className="inline-flex items-center gap-2.5 font-mono text-[10px] uppercase tracking-[0.3em] text-iron-gold">
            <span aria-hidden className="inline-block h-1.5 w-1.5 rounded-full bg-iron-gold shadow-[0_0_10px_rgba(250,204,21,0.85)]" />
            Protocol &mdash; Iron Man
          </span>
          <h2 className="font-heading leading-[0.88] tracking-tighter text-foreground text-[clamp(4.5rem,10.5vw,10rem)]">
            Armor
            <br />
            is <span className="text-iron-red shimmer-iron">Eternal</span>
          </h2>
          <p className="max-w-[36ch] font-mono text-[11px] uppercase tracking-[0.22em] text-zinc-400">
            A legacy forged in iron and sacrifice, protecting the future.
          </p>
        </div>
        ...
        <div className="pointer-events-none absolute right-6 top-20 z-10 flex items-center gap-3 md:right-10 md:top-24">
          ...
          <span
            ref={powerReadoutRef}
            className="font-mono text-[10px] uppercase tracking-[0.22em] text-iron-gold"
          >
            18.12.26
          </span>
          <span aria-hidden className="inline-block h-1.5 w-1.5 rounded-full bg-iron-red shadow-[0_0_10px_rgba(239,68,68,0.85)]" />
        </div>
        ...
        <div className="pointer-events-none absolute inset-x-0 bottom-0 z-10">
          ...
          <div className="mx-6 flex items-center justify-between pb-4 font-mono text-[10px] uppercase tracking-[0.28em] text-zinc-500 md:mx-10">
            <span>IRON MAN // 2008-2019</span>
            <span>MULTIVERSE // EARTH-616 // DIAGNOSTIC</span>
        ...
        {!loaded && (
          <div className="absolute inset-0 z-30 flex flex-col items-center justify-center gap-5 bg-background px-6">
            <EyebrowBadge>DOOMSDAY PROTOCOL // BOOTING</EyebrowBadge>
            ...
            <p className="font-mono text-[11px] uppercase tracking-[0.28em] text-zinc-500">
              Initializing Doomsday &nbsp;&middot;&nbsp; {Math.round(loadProgress * 100)}%
            </p>
          </div>
        )}
      </div>
